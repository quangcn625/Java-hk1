 ...
 */
package J05049_LietKeNhapXuatTheonhom;
import java.util.*;
...
class NhapXuat implements Comparable<NhapXuat>{
    ...
    @Override
    public int compareTo(NhapXuat o) {
        return o.getThue() - this.getThue();
    }
...
public class Main {
    public static void main(String[] args) {
        ...
        for(NhapXuat x : list){
            if(x.getMa().substring(0, 1).equals(s)) System.out.println(x);
        }
    }
}
/*
